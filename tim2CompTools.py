...
def compressBadly(uncompressed_data):
    """
    While I know how the game decompresses files, I don't necessarily know how
    it searches for copies to do the compression in the first place. The easy
    answer is just 'don't compress anything and use only 1-byte commands', which
    is what this function does.

    I may work on finding a way to re-compress them later, but for now, this is
    easier.
    """

    compressed_data = b''

    largest_number_of_bits = 127
